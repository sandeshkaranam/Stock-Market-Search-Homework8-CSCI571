...
https.get('https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&outputsize=full&symbol='+req.query.stock+'&interval=daily&apikey=B7Q03XG89RUCBSPJ', (resp) => {
  let data = '';
...
router.get('/timeseriesdailycompact', function(req, res, next) {
  console.log(req.query.stock);
https.get('https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol='+req.query.stock+'&interval=daily&apikey=B7Q03XG89RUCBSPJ', (resp) => {
  let data = '';
...
router.get('/graphSMA', function(req, res, next) {
  https.get('https://www.alphavantage.co/query?function=SMA&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
    let data = '';
  ...
  router.get('/graphCCI', function(req, res, next) {
    https.get('https://www.alphavantage.co/query?function=CCI&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
      let data = '';
    ...
    router.get('/graphADX', function(req, res, next) {
      https.get('https://www.alphavantage.co/query?function=ADX&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
        let data = '';
      ...
      router.get('/graphEMA', function(req, res, next) {
        https.get('https://www.alphavantage.co/query?function=EMA&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
          let data = '';
        ...
        router.get('/graphRSI', function(req, res, next) {
          https.get('https://www.alphavantage.co/query?function=RSI&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
            let data = '';
        ...
        router.get('/graphBBANDS', function(req, res, next) {
          https.get('https://www.alphavantage.co/query?function=BBANDS&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
            let data = '';
        ...
        router.get('/graphMACD', function(req, res, next) {
          https.get('https://www.alphavantage.co/query?function=MACD&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
            let data = '';
          ...
          https.get('https://www.alphavantage.co/query?function=STOCH&symbol='+req.query.stock+'&interval=daily&time_period=10&series_type=close&apikey=B7Q03XG89RUCBSPJ', (resp) => {
            let data = '';
